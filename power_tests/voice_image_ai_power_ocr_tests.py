...
image_folder = "Smart Glasses Voice Image AI Power Tests"
...
for filename in sorted(os.listdir(image_folder), key=numerical_sort):
    ...
    prompt = f"Get the current from this text originating from a power supply reading, just include the number and nothing else in your response. Use .037 if you can't find a reading."
